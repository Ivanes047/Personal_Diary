...
public class helpJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Дневник ");

        jLabel1.setText("<html>Эта программа создана для ведения личного дневника. В нее можно записывать свои мысли, переживания, делиться впечатлениями и ставить оценку прожитым дням.  </html>");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Разработчик: Борисов Иван 201-363");
